...
set_hl(0, 'Todo', { fg = '#eeeeee', bold = true })
set_hl(0, 'ShadyFg3', { fg = '#bdae93' })
set_hl(0, 'ShadyFg1', { fg = '#ebdbb2' })
set_hl(0, 'ShadyBg2', { fg = '#504945' })
set_hl(0, 'ShadyBlue', { fg = '#83a598' })
set_hl(0, 'ShadyBrightBlue', { fg = '#a5c7ff' })
set_hl(0, 'ShadyAqua', { bg = '#8ec07c' })
set_hl(0, 'ShadyGray', { fg = '#928374' })
set_hl(0, 'ShadyYellow', { fg = '#fabd2f' })
set_hl(0, 'ShadyOrange', { fg = '#fe8019' })
set_hl(0, 'MatchParen', { link = 'ShadyOrange' })
...
set_hl(0, 'DiagnosticInformation', { link = 'WhiteHover' })
set_hl(0, 'DiagnosticHint', { link = 'HintSign' })
set_hl(0, 'LspReferenceText', { link = 'AquaHover' })
set_hl(0, 'LspReferenceRead', { link = 'BlueHover' })
set_hl(0, 'LspReferenceWrite', { link = 'GreenHover' })
...
set_hl(0, 'WinSeparator', { bg = '#141414', fg = '#c9c9c9' })
